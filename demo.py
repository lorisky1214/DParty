    ...
    def recognize(self):
        ...
        with self.mp_hands.Hands(min_detection_confidence=0.7,
            ...
            while cap.isOpened():
                ...
                # 显示距离
                cv2.putText(self.image, "Dist:" + str(rect_percent_text), (10, 120), cv2.FONT_HERSHEY_PLAIN, 3,
                            (1, 255, 0), 3)

                # 显示当前激活
                cv2.putText(self.image, "Selected:" + (
                    "None" if squareManager.active_index == -1 else str(squareManager.active_index)), (10, 170),
                            cv2.FONT_HERSHEY_PLAIN, 3, (1, 255, 0), 3)
                ...
                cv2.imshow('Finger Drag Test', self.image)
